/* To-Do-List control */
app.controller('ToDoCtrl', ['$scope', '$ionicActionSheet', '$ionicPopup', '$timeout', '$localstorage', '$cordovaDatePicker', 'calendarService', 'toDoService', function($scope, $ionicActionSheet, $ionicPopup, $timeout, $localstorage, $cordovaDatePicker, calendarService, toDoService) {
  ...
  $scope.addToDoDate = function( item ) {
	...
	$cordovaDatePicker.show(options).then(function(date){
		...
		var toDo = {
				  title: obj.title,
				  date: obj.end.toDateString(),
				  id: toDoService.getNumberOf()
		};
        calendarService.addToList(obj);		
		toDoService.addToList(toDo);
		$localstorage.setObject( 'calendar', toDoService.output() );
